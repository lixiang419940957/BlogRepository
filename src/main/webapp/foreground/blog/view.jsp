...
<script type="text/javascript"
	src="${basePath}/static/ueditor/third-party/SyntaxHighlighter/shCore.js"></script>
<!-- <script type="text/javascript" -->
<%-- 	src="${basePath}/static/jquery-easyui-1.4.5/jquery.min.js"></script> --%>
<link rel="stylesheet"
	href="${basePath}/static/ueditor/third-party/SyntaxHighlighter/shCoreDefault.css">
<script type="text/javascript">
...
<!-- 	<div class="data_list_title"> -->
<!-- 		<img -->
<%-- 			src="${basePath}/static/images/comment_icon.png" /> --%>
<!-- 		评论信息 -->
...
<!-- 	<div class="data_list_title"> -->
<!-- 		<img -->
<%-- 			src="${basePath}/static/images/publish_comment_icon.png" /> --%>
<!-- 		发表评论 -->
<!-- 	</div> -->
...
<%-- 				id="randImage" src="${basePath}/image.jsp" --%>
